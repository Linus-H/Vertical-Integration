...
%Often, $s$ will be dependent on pressure $p$ in some way, as this way an equidistant spacing of $s$ will correspond to higher spatial resolution in areas where $p$ is changing a lot.\\
...
Using Leibnitz's notation, the replacement for vertical spatial derivatives can be rewritten as follows:
\begin{align}
